...
class VelocimetroWidget(QWidget):
    def __init__(self):
        ...
        self.setFixedSize(400, 250)  # Ajuste da altura para mais espaço
    ...
    def paintEvent(self, event):
        ...
        # Desenhando a escala
        for i in range(0, 41, 5):  # Escala de 0 a 40
        ...
        for i in range(0, 41, 5):  # Mostra todos os valores (incluindo intermediários)
            angle = math.radians(180 - (180 * (i / 40)))  # Ajuste para direção correta
